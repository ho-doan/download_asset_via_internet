...
abstract class UncompressDelegate {
  ...
  /// uncompress the asset located at
  /// [compressedFilePath] to the specified [assetsDir].
  /// [compressedFilePath] -> The path to the compressed asset file.
  /// [assetsDir] -> The directory where the uncompressed asset
  /// should be stored.
  /// Returns a [Future] representing the completion of the
